...
function create(task = {}) {
  ...
  db().prepare(`
    INSERT INTO tasks (id, title, description, agent, status, priority, deadline, success_criteria, context_files, needs_approval)
    VALUES (@id, @title, @description, @agent, @status, @priority, @deadline, @success_criteria, @context_files, @needs_approval)
