...
function create(task = {}) {
  ...
  db().prepare(`
    INSERT INTO tasks (id, title, description, agent, status, priority, deadline, success_criteria, context_files)
    VALUES (@id, @title, @description, @agent, @status, @priority, @deadline, @success_criteria, @context_files)
